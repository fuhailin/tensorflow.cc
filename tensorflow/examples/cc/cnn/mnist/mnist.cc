...
// The correspoding python version: https://github.com/tensorflow/models/tree/master/tutorials/image/mnist
//
// Author: Rock Zhuang
// Date  : Jan 23, 2019
//
...
int main() {
  ...
  // Convnet Model begin
  auto conv2d_1 = Conv2D(scope, 
                        ph_inputs,
                        conv1_weights, 
                        gtl::ArraySlice<int>{1, 1, 1, 1},
                        "SAME");
