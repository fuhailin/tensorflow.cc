...
#include "tensorflow/cc/ops/cudnn_rnn_ops_internal.h"
...
CudnnRNNBackpropV3::CudnnRNNBackpropV3(const ::tensorflow::Scope& scope,
                                       ::tensorflow::Input input,
                                       ::tensorflow::Input input_h,
                                       ::tensorflow::Input input_c,
                                       ::tensorflow::Input params,
                                       ::tensorflow::Input sequence_lengths,
                                       ::tensorflow::Input output,
                                       ::tensorflow::Input output_h,
                                       ::tensorflow::Input output_c,
                                       ::tensorflow::Input output_backprop,
                                       ...
                                       ::tensorflow::Input reserve_space,
                                       ::tensorflow::Input host_reserved, const
                                       CudnnRNNBackpropV3::Attrs& attrs) {
  if (!scope.ok()) return;
  auto _input = ::tensorflow::ops::AsNodeOut(scope, input);
  if (!scope.ok()) return;
  auto _input_h = ::tensorflow::ops::AsNodeOut(scope, input_h);
  ...
  auto _params = ::tensorflow::ops::AsNodeOut(scope, params);
  if (!scope.ok()) return;
  auto _sequence_lengths = ::tensorflow::ops::AsNodeOut(scope, sequence_lengths);
  if (!scope.ok()) return;
  auto _output = ::tensorflow::ops::AsNodeOut(scope, output);
  if (!scope.ok()) return;
  auto _output_h = ::tensorflow::ops::AsNodeOut(scope, output_h);
  ...
  if (!scope.ok()) return;
  ::tensorflow::Node* ret;
  const auto unique_name = scope.GetUniqueNameForOp("CudnnRNNBackpropV3");
  auto builder = ::tensorflow::NodeBuilder(unique_name, "CudnnRNNBackpropV3")
                     .Input(_input)
                     .Input(_input_h)
                     .Input(_input_c)
                     .Input(_params)
                     .Input(_sequence_lengths)
                     .Input(_output)
                     .Input(_output_h)
                     .Input(_output_c)
                     .Input(_output_backprop)
...
CudnnRNNBackpropV3::CudnnRNNBackpropV3(const ::tensorflow::Scope& scope,
                                       ...
                                       ::tensorflow::Input reserve_space,
                                       ::tensorflow::Input host_reserved)
  : CudnnRNNBackpropV3(scope, input, input_h, input_c, params, sequence_lengths, output, output_h, output_c, output_backprop, output_h_backprop, output_c_backprop, reserve_space, host_reserved, CudnnRNNBackpropV3::Attrs()) {}
...
CudnnRNNV3::CudnnRNNV3(const ::tensorflow::Scope& scope, ::tensorflow::Input
                       input, ::tensorflow::Input input_h, ::tensorflow::Input
                       input_c, ::tensorflow::Input params, ::tensorflow::Input
                       sequence_lengths, const CudnnRNNV3::Attrs& attrs) {
  if (!scope.ok()) return;
  auto _input = ::tensorflow::ops::AsNodeOut(scope, input);
  if (!scope.ok()) return;
  auto _input_h = ::tensorflow::ops::AsNodeOut(scope, input_h);
  ...
  if (!scope.ok()) return;
  ::tensorflow::Node* ret;
  const auto unique_name = scope.GetUniqueNameForOp("CudnnRNNV3");
  auto builder = ::tensorflow::NodeBuilder(unique_name, "CudnnRNNV3")
                     .Input(_input)
                     .Input(_input_h)
                     .Input(_input_c)
                     .Input(_params)
...
CudnnRNNV3::CudnnRNNV3(const ::tensorflow::Scope& scope, ::tensorflow::Input
                       ...
                       input_c, ::tensorflow::Input params, ::tensorflow::Input
                       sequence_lengths)
  : CudnnRNNV3(scope, input, input_h, input_c, params, sequence_lengths, CudnnRNNV3::Attrs()) {}
