...
#ifndef TENSORFLOW_CC_OPS_CUDNN_RNN_OPS_INTERNAL_H_
#define TENSORFLOW_CC_OPS_CUDNN_RNN_OPS_INTERNAL_H_
...
/// * `Output` input_c_backprop
/// * `Output` params_backprop
class CudnnRNNBackpropV3 {
 public:
  /// Optional attribute setters for CudnnRNNBackpropV3
  struct Attrs {
    /// Defaults to "lstm"
    TF_MUST_USE_RESULT Attrs RnnMode(StringPiece x) {
      Attrs ret = *this;
  ...
  CudnnRNNBackpropV3(const ::tensorflow::Scope& scope, ::tensorflow::Input input,
                   ::tensorflow::Input input_h, ::tensorflow::Input input_c,
                   ::tensorflow::Input params, ::tensorflow::Input
                   sequence_lengths, ::tensorflow::Input output,
                   ::tensorflow::Input output_h, ::tensorflow::Input output_c,
                   ::tensorflow::Input output_backprop, ::tensorflow::Input
                   output_h_backprop, ::tensorflow::Input output_c_backprop,
                   ::tensorflow::Input reserve_space, ::tensorflow::Input
  ...
  CudnnRNNBackpropV3(const ::tensorflow::Scope& scope, ::tensorflow::Input input,
                   ...
                   output_h_backprop, ::tensorflow::Input output_c_backprop,
                   ::tensorflow::Input reserve_space, ::tensorflow::Input
                   host_reserved, const CudnnRNNBackpropV3::Attrs& attrs);
...
class CudnnRNNV3 {
 public:
  /// Optional attribute setters for CudnnRNNV3
  struct Attrs {
    /// Defaults to "lstm"
    TF_MUST_USE_RESULT Attrs RnnMode(StringPiece x) {
      Attrs ret = *this;
  ...
  CudnnRNNV3(const ::tensorflow::Scope& scope, ::tensorflow::Input input,
           ::tensorflow::Input input_h, ::tensorflow::Input input_c,
           ::tensorflow::Input params, ::tensorflow::Input sequence_lengths);
  CudnnRNNV3(const ::tensorflow::Scope& scope, ::tensorflow::Input input,
           ::tensorflow::Input input_h, ::tensorflow::Input input_c,
           ::tensorflow::Input params, ::tensorflow::Input sequence_lengths,
           const CudnnRNNV3::Attrs& attrs);
...
#endif  // TENSORFLOW_CC_OPS_CUDNN_RNN_OPS_INTERNAL_H_
